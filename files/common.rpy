...
translate spanish strings:
    ...
    new "Menú de accesibilidad. Usa las flechas de arriba y abajo para navegar, y la tecla Intro para activar botones y barras."
    ...
    new "Haz clic para cambiar el atributo, haz clic con el botón derecho para cambiar el atributo negativo."
    ...
    new "Haz clic para establecer, haz clic con el botón derecho para añadir a la lista de detrás."
    ...
    new "Cargar la partida hará que pierdas el progreso no guardado.\n¿Seguro que quieres hacer esto?"
    ...
    new "¿Seguro que quieres empezar a omitir?"
    ...
    new "¿Seguro que quieres omitir los diálogos no vistos hasta la siguiente elección?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Este guardado fue creado en un dispositivo diferente. Los archivos de guardado creados con fines maliciosos pueden dañar tu ordenador. ¿Confías en el creador de este guardado y en todos los que podrían haber modificado el archivo?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "¿Confías en el dispositivo en el que se creó el guardado? Solo deberías elegir sí si eres el único usuario del dispositivo."
    ...
    new "Este programa contiene software libre bajo varias licencias, incluyendo la Licencia MIT y la Licencia Pública General Reducida de GNU. Se puede encontrar una lista completa del software, incluyendo enlaces al código fuente completo {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    new "La autovoz diría \"[renpy.display.tts.last]\". Pulsa 'alt+shift+V' para desactivarla."

    # renpy/common/00preferences.rpy:705
    old "Self-voicing enabled. Press 'v' to disable."
    new "Autovoz activada. Pulsa 'v' para desactivarla."
    ...
    new "(limpiar bocadillos retenidos)"
    ...
    new "El servidor de Ren'Py Sync se ha agotado."
    ...
    new "El servidor de Ren'Py Sync no tiene una copia de esta sincronización. El ID de sincronización puede no ser válido o puede haber caducado."
    ...
    new "Esto subirá tus guardados al {a=https://sync.renpy.org}servidor de Ren'Py Sync{/a}.\n¿Quieres continuar?"
    ...
    new "O este proyecto no admite actualizaciones, o el archivo de estado de la actualización ha sido eliminado."
    ...
    new "El archivo de actualización no tiene el resumen correcto; puede que esté dañado."
    ...
    new "Las actualizaciones se cancelaron."
    ...
    new "Este ordenador está utilizando renderización por software."
    ...
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información que le ayude a determinar qué le pasa a su ordenador."
    ...
    new "Ignora la excepción, permitiéndote continuar. Esto a menudo conduce a errores adicionales."
